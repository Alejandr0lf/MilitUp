 ...
 * atributo "Moral" del jugador.
 */
public class moralQuestion {
      ...
      * atributo principal que se afecta es el "Moral", este es el que debe tener un
      * valor mayor que los demás
      * 
      * @return Retorna un número de 6 a 10
      */
     public static int RandomMoral() {
          return SubClassRandomGenerative.RandomX(true);
     }

     /**
      * Este método retorna un número Random que irá de 1 a 5, puesto que como el
      * atributo principal que se afecta es el "Moral", los demás no deben estár por
     ...
     public static void YesOrNot(boolean answer, Militar jugador) {
          ...
          if (!answer) {
               SubClassExecuteQuestion.modificarEstadisticas(jugador, RandomOthers(), RandomOthers(), RandomMoral(),
                         RandomOthers(), RandomOthers(), RandomOthers(), RandomMoral(), RandomOthers(), false);
          }
     }
